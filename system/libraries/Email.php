...
class CI_Email {
	...
	var	$smtp_host		= "mail.sefasgroup.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "it@sefasgroup.com";		// SMTP Username
	var	$smtp_pass		= "RR3tri3v3";		// SMTP Password
